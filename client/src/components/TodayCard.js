...
const TodayCard = ({ plant, status }) => {
	return (
		<div className='bg-lg rounded-lg overflow-hidden shadow relative h-80'>
			...
			{status.fertilize ? (
				<div className='absolute top-0 left-10 ml-2 mt-2 bg-light rounded-full w-9 h-9 flex items-center justify-center'>
			...
			{status.prune ? (
				<div className='absolute top-0 left-20 ml-2 mt-2 bg-light rounded-full w-9 h-9 flex items-center justify-center'>
